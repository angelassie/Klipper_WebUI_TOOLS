...
MCU_PLATFORMS = {
    ...
    "STM32": {
        ...
        "bootloader": {
            ...
            "STM32F405": ["No bootloader", "32KiB bootloader", "64KiB bootloader",
                          "128KiB bootloader", "128KiB bootloader with 512 byte offset"],
            "STM32F407": ["No bootloader", "32KiB bootloader", "64KiB bootloader",
                          "128KiB bootloader", "128KiB bootloader with 512 byte offset"],
            "STM32F429": ["No bootloader", "32KiB bootloader", "64KiB bootloader",
                          "128KiB bootloader", "128KiB bootloader with 512 byte offset"],
